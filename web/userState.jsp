        ...
        <div class="container">
            <div class="nav-wrapper">
                <div class="col s12">
                    ...
                    <a href="" class="breadcrumb">用户状态管理</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <li class="bold"><a class="collapsible-header  waves-effect waves-teal active">用户管理</a>
                    <div class="collapsible-body">
                        <ul>
                            ...
                            <li class="active"><a href="userState.jsp" class="collection-item">用户状态管理</a></li>
                        </ul>
                    </div>
                </li>
        ...
        <table>
            ...
            <s:iterator id="uiItem" value="#session.USERS_LIST">
                <tr>
                    ...
                    <td><a class="waves-effect waves-light btn" href="#modal${uiItem.id}">修改权限</a></td>
                </tr>
                ...
                <div id="modal${uiItem.id}" class="modal">
                    <div class="modal-content">
                        ...
                        <p>邮箱：${uiItem.mail}</p>
                        <p>权限级别</p>
                        <input type="number" value="${uiItem.userRoleId }" size="10"
                               onchange="window.location='setUserRole?userId=${uiItem.id}&role='+this.value;" />
                    </div>
                    <div class="modal-footer">
